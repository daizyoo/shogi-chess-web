/* @ts-self-types="./hybrid_board_ai_wasm.d.ts" */
...
export class WasmAI {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WasmAIFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmai_free(ptr, 0);
    }
    /**
     ...
     */
    get_depth() {
        const ret = wasm.wasmai_get_depth(this.__wbg_ptr);
        return ret;
    }
    /**
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./hybrid_board_ai_wasm_bg.js": import0,
    };
}

const WasmAIFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmai_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('hybrid_board_ai_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
